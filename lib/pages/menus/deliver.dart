...
import 'package:projectgetx/pages/menus/deliver_mobile.dart';
import 'package:projectgetx/pages/menus/deliver_tablet.dart';
...
class Deliver extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Update screen width whenever build is called
